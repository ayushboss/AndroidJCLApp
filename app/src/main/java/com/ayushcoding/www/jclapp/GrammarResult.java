...
public class GrammarResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = (TextView) findViewById(R.id.scoreGrammar);
        Bundle b = getIntent().getExtras();
        final int scoreRHTHING= b.getInt("scoreGrammar");
        Context context = this;

        score.setText(""+ scoreRHTHING+ "");
        final ScoresDB scoresDB = new ScoresDB(GrammarResult.this);
...
//                        ScoresDB scoresDB = new ScoresDB(GrammarFinished.this);
                        scoresDB.addScore("grammar", scoreRHTHING, 10);
                        break;

                    case DialogInterface.BUTTON_NEGATIVE:
                        //No button clicked
//                        scoresDB = new ScoresDB(GrammarFinished.this);
                        scoresDB.ScoreUpdate("grammar", scoreRHTHING);
                        break;
                }
            }
        };
