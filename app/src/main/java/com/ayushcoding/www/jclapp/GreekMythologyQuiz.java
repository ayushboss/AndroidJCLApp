...
public class GreekMythologyQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_greek_mythology_quiz);
        GreekMythologyQuestionsDB db = new GreekMythologyQuestionsDB(this);
        quesList = db.getAllQuestions();
        currentQ = quesList.get(qid);
        txtQuestion = (TextView) findViewById(R.id.questionMyth);
        opt1 = (Button) findViewById(R.id.buttonMyth);
        opt2 = (Button) findViewById(R.id.button2Myth);
        opt3 = (Button) findViewById(R.id.button3Myth);
        opt4 = (Button) findViewById(R.id.button4Myth);
        setQuestionView();
        ...
        mToolbar.setTitle("Greek Mythology Quiz");
       ...
       final ImageView pin = (ImageView) findViewById(R.id.pinQuestionMyth);
        ...
        pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotecardDB notecard = new NotecardDB(GreekMythologyQuiz.this);
                notecard.addQuestion(currentQ.getQUESTION(), currentQ.getANSWER(), "myth");
            }
        });
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qid < 10) {
                    ...
                    Intent intent = new Intent(GreekMythologyQuiz.this, GreekMythologyResult.class);

                    Bundle b = new Bundle();

                    b.putInt("scoreMyth", score); //Your score
