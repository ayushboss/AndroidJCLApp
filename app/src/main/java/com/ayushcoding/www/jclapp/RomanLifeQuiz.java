...
public class RomanLifeQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roman_life_quiz);
        RomanLifeQuizDB db=new RomanLifeQuizDB(this);
        ...
        txtQuestion = (TextView) findViewById(R.id.questionRlife);
        opt1 = (Button) findViewById(R.id.buttonRlife);
        opt2 = (Button) findViewById(R.id.button2Rlife);
        opt3 = (Button) findViewById(R.id.button3Rlife);
        opt4 = (Button) findViewById(R.id.button4Rlife);
        final ImageView pin = (ImageView) findViewById(R.id.pinQuestionRlife);
        mToolbar = (Toolbar) findViewById(R.id.toolbarRLQ);
         ...
         pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!buttonPushed){
                    ...
                    snackbarPin.show();
                    NotecardDB notecard = new NotecardDB(RomanLifeQuiz.this);
                    notecard.addQuestion(currentQ.getQUESTION(), currentQ.getANSWER(), "rl");
                    buttonPushed = true;
                }
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qid < 10) {
                    ...
                    Intent intent = new Intent(RomanLifeQuiz.this, RomanLifeResult.class);
