...
public class GrammarQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GrammarQuizDB db = new GrammarQuizDB(this);
        quesList = db.getAllQuestions();
        currentQ = quesList.get(qid);
        txtQuestion = (TextView) findViewById(R.id.questionGrammar);
        opt1 = (Button) findViewById(R.id.buttonGrammar);
        opt2 = (Button) findViewById(R.id.button2Grammar);
        opt3 = (Button) findViewById(R.id.button3Grammar);
        opt4 = (Button) findViewById(R.id.button4Grammar);
        ...
        mToolbar.setTitle("Grammar Quiz");
        ...
        setQuestionView();
       final ImageView pin = (ImageView) findViewById(R.id.pinQuestionGram);
        ...
        pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotecardDB notecard = new NotecardDB(GrammarQuiz.this);
                notecard.addQuestion(currentQ.getQUESTION(), currentQ.getANSWER(), "gram");
            }
        });
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qid < 10) {
                    ...
                    Intent intent = new Intent(GrammarQuiz.this, GrammarResult.class);

                    Bundle b = new Bundle();

                    b.putInt("scoreGrammar", score); //Your score
