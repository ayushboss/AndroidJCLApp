...
public class MottoesQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mottoes_quiz);
        MottoesDb db = new MottoesDb(this);
        quesList = db.getAllQuestions();
        currentQ = quesList.get(qid);
        txtQuestion = (TextView) findViewById(R.id.questionMo);
        opt1 = (Button) findViewById(R.id.Mo1);
        opt2 = (Button) findViewById(R.id.Mo2);
        opt3 = (Button) findViewById(R.id.Mo3);
        opt4 = (Button) findViewById(R.id.Mo4);
        mToolbar = (Toolbar) findViewById(R.id.toolbarMottoes);
        ...
        setQuestionView();
        final ImageView pin = (ImageView) findViewById(R.id.pinQuestionMo);
        ...
        pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!buttonPushed){
                    ...
                    snackbarPin.show();
                    buttonPushed = true;
                    NotecardDB notecard = new NotecardDB(MottoesQuiz.this);
                    notecard.addQuestion(currentQ.getQUESTION(), currentQ.getANSWER(), "mottoes");
                }
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qid < 10) {
                    ...
                    Intent intent = new Intent(MottoesQuiz.this, GrammarResult.class);

                    Bundle b = new Bundle();

                    b.putInt("scoreMottoes", score); //Your score
